...
<head>
    ...
    <title>Edit Alat Gunung - M.A OUTDOR Rent</title>
    <style>
        ...
        .btn-submit { width: 100%; padding: 12px; background-color: #f39c12; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; font-weight: bold; margin-top: 10px; }
    ...
    <div class="container">
        ...
        <form action="/product/update/{{ $product->id }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_alat" value="{{ $product->nama_alat }}" required>
            </div>

            <div class="form-group">
                <label>Harga Sewa / Hari (Rp)</label>
                <input type="number" name="harga_sewa" value="{{ $product->harga_sewa }}" required>
            </div>
            ...
            <button type="submit" class="btn-submit">Update Alat Gunung</button>
